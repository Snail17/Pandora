package com.pandora.modular.live.util;
...
public class MyMediaController extends MediaController {
    ...
    private View mVolumeBrightnessLayout;//声音控制的界面
    private ImageView mOperationBg;
    private TextView mOperationTv;
    private AudioManager mAudioManager;//媒体声音管理器
...
//        mHandler.sendEmptyMessageDelayed(0, 500);
    ...
    private class MyGestureListener extends GestureDetector.SimpleOnGestureListener {
        ...
        public boolean onScroll(MotionEvent e1, MotionEvent e2, float distanceX, float distanceY) {
            ...
            if (mOldX > windowWidth * 3.0 / 4.0) {// 右边滑动 屏幕3/5 //滑动改变声音
                onVolumeSlide((mOldY - y) / windowHeight);
            } else if (mOldX < windowWidth * 1.0 / 4.0) {// 左边滑动 屏幕2/5
                onBrightnessSlide((mOldY - y) / windowHeight);//滑动改变亮度
            }
